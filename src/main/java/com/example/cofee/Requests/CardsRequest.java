...
/**
 * Сущность запроса к контроллеру карт
 */
public class CardsRequest {
    ...
    public CardsRequest(Long id, String cardNum, Double discount, String clientName, String clientSername, String clientSecondName) {
        this.id = id;
